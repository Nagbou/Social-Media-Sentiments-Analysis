...
function Charts() {
    return (
        <div className={styles.container}>
            ...
            <p className={styles.intro}>Discover interactive charts that enhance your understanding of features and data insights.</p>
            ...
            <>
                <div className="row pt-5">
                    ...
                    <div className={`${styles.barsContainer} ms-5 col col-6`}>
                        ...
                        <PieChartComponent dataKey="value" nameKey='platform' csvpath="/imgs/tables/number_posts_by_platform.csv" />
                    </div>
                </div>
            </>
            {/* by year  */}
            <>
                <div className="row mt-5">
                    ...
                    <div className={`${styles.barsContainer} ms-4 col col-4`}>
                        <h3 className='mb-4'>Sample Count by Platform</h3>
                        <PieChartComponent dataKey="value" nameKey='Country' csvpath="/imgs/tables/number_posts_by_country.csv" />
            ...
            <>
                <div className="row pt-5">
                    <div className={`${styles.barsContainer} col col-5`}>
                        ...
                        <PieChartComponent dataKey="value" nameKey='year' csvpath="/imgs/tables/number_posts_by_year.csv" />
                    </div>
                    <div className={`${styles.barsContainer} ms-5 col col-6`}>
